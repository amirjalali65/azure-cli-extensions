...
class MLBehaviorAnalyticsAlertRule(AlertRule):
    ...
    :vartype severity: str or ~alertrules.models.AlertSeverity
    :ivar tactics: The tactics of the alert rule
    :vartype tactics: list[str or ~alertrules.models.AttackTactic]
    """
    ...
    def __init__(self, *, alert_rule_template_name: str, enabled: bool, etag: str=None, **kwargs) -> None:
        super(MLBehaviorAnalyticsAlertRule, self).__init__(etag=etag, **kwargs)

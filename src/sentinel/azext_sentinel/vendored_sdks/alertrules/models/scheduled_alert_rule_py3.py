...
class ScheduledAlertRule(AlertRule):
    ...
    def __init__(self, *, display_name: str, enabled: bool, suppression_duration, suppression_enabled: bool, etag: str=None, query: str=None, query_frequency=None, query_period=None, severity=None, trigger_operator=None, trigger_threshold: int=None, event_grouping_settings=None, custom_details=None, entity_mappings=None, alert_details_override=None, alert_rule_template_name: str=None, description: str=None, tactics=None, incident_configuration=None, **kwargs) -> None:
